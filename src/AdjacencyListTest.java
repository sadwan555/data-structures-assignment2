 ...
 * and test the methods of the adjacency list graph implementation.
 *
 ...
 * removing an edge or vertex correctly updates the adjacency lists.
 */
public class AdjacencyListTest {
   public static void main(String[] args) throws Exception {
      ...
      // this is the important adjacency-list test mentioned in the assignment
